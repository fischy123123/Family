...
CRITICAL — NET-NEW ONLY (this is the entire point of recommendations): The family already SEES their calendar events, their open tasks, and the main briefing. A recommendation that restates, rephrases, or "reminds" them of something already on their radar is WORTHLESS and makes the assistant look broken. Before emitting ANY recommendation, ask: "Is this already visible to them as a calendar event, an open task, or an obvious next step they're clearly already on top of?" If YES, DROP IT. A valid recommendation surfaces something they have NOT thought of — a second-order consequence, a gap between two events, a conflict they haven't connected, a preparation window closing, an opportunity hiding in the data, or a stress they'd feel later but can defuse now. Think "the thing a sharp friend would notice that you missed," never "here is your to-do list again." Quality over quantity: it is far better to return {"recommendations":[]} than to pad with restated tasks. Return 0-3, and 0 is the right answer unless you have a genuinely non-obvious insight. If nothing is genuinely net-new and helpful, return {"recommendations":[]}.`
  }
  // items
