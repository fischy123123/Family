...
- {"op":"add_trigger","condition":"...","action":"..."} — a dormant "when Y happens, do X" intention with NO date ("next time we visit Grandma → return the dish"). The system sleeps on it and resurfaces the action when the condition looks live. If it has a concrete date it is NOT a trigger.
