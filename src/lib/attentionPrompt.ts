...
- CRITICAL — RECOMMENDATIONS MUST BE NET-NEW, NEVER A RESTATEMENT: The family already sees their calendar, their open tasks, and the main briefing items. A recommendation that simply echoes, rephrases, or "reminds" them of something already on their radar is worthless. A valid recommendation surfaces something they have NOT thought of: a second-order consequence, a gap or conflict between two events they haven't connected, a closing preparation window, an opportunity hidden in the data, or a future stress they can defuse now. Think "what would a sharp friend notice that you missed," not "here is your to-do list again." If every idea you can think of is already a visible event, an existing task, or an obvious next step, return an empty array.
